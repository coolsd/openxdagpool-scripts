...
if [ $? -eq 0 ]; then
	"$DL" https://raw.githubusercontent.com/XDagger/xdag/master/client/netdb-white.txt -O /var/www/html/public/netdb-white.txt 2>/dev/null
	...
	"$DL" https://raw.githubusercontent.com/XDagger/xdag/master/client/netdb-white.txt --output /var/www/html/public/netdb-white.txt 2>/dev/null
...
grep -Pha "^[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}:[0-9]{1,5}$" /var/www/html/netdb-white.txt > /var/www/html/public/netdb-filtered.txt

LINES1="`wc -l /var/www/html/public/netdb-white.txt | cut -d ' ' -f 1`"
LINES2="`wc -l /var/www/html/public/netdb-filtered.txt | cut -d ' ' -f 1`"

if [ "$LINES1" == "0" ]; then
	rm /var/www/html/public/netdb-white.txt /var/www/html/public/netdb-filtered.txt
...
rm /var/www/html/public/netdb-white.txt
...
while read -u 10 LINE; do
	...
	if [ $? -eq 0 ]; then
		rm /var/www/html/public/netdb-filtered.txt
...
done 10</var/www/html/public/netdb-filtered.txt

mv /var/www/html/public/netdb-filtered.txt /root/xdag1/client/netdb-white.txt
cp /root/xdag1/client/netdb-white.txt /root/xdag2/client/netdb-white.txt
