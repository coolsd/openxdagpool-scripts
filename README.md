...
After that, go to `/home/pool/scripts/engine` directory (as user `pool`) and execute `php core.php livedata`. You should see JSON with pool statistics, verifying the setup is correct.
