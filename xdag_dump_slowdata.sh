...
grep -Pha "`/usr/bin/php /home/pool/scripts/generate_last_days_regex.php`"'.+:INFO]  Paid  : [0-9a-f]{64}' /home/pool/xdag1/client/xdag.log* /home/pool/xdag2/client/xdag.log* | sort > /var/www/pool/blocks_tmp.txt
